...
#Guild
MAIN_SERVER = 0000000000000000000 #GOOBERS
TEST_SERVER = 0000000000000000000 #BOF Test Server
SERVER = None #Server to be updated based on if we are in testing mode

#leaderboard channels
LEADERBOARD_CHANNEL_MAIN = 0000000000000000000 #GOOBERS
LEADERBOARD_CHANNEL_TEST = 0000000000000000000 #BOF Test Server
LEADERBOARD_CHANNEL = None #channel to be updated based on if we are in testing mode

LEADERBOARD_MESSAGE_MAIN = 0000000000000000000 #GOOBERS
LEADERBOARD_MESSAGE_TEST = 0000000000000000000 #BOF Test Server
LEADERBOARD_MESSAGE = None #message id to be updated based on if we are in testing mode

#post channels
BOF_MAIN_CHANNEL = 0000000000000000000 #GOOBERS
BOF_TEST_CHANNEL = 0000000000000000000 #BOF Test Server
BOF_CHANNEL = None #channel to be updated based on if we are in testing mode

MAIN_BIG_ROLE = 0000000000000000000 #GOOBERS
TEST_BIG_ROLE = 0000000000000000000 #BOF Test Server
